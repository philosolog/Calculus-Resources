...
\begin{frame}
	...
	\vspace*{\fill}
	\begin{enumerate}
		\item Write an equation that models the average global temperature of Planet X in $t$ decades from now. % Q_avg = 0.156t + 21.4
		      \vspace*{\fill}
		\item Using your linear model, approximate the amount of time it will take for the planet to exceed a $Q_{\text{avg}}$ of $25\degree$C. % 23.0769 decades
	\end{enumerate}
	\vspace*{\fill}
	\vspace*{\fill}
	\crono
