...
\begin{questions}
	...
	\question From the graphs of $f$, $g$, and $h$, estimate the value of $g(f(h(x))$ for $\{x\hspace{0.125cm}\epsilon\hspace{0.125cm}\mathbb{Z} \mid -3\leq x\leq 3\}$. % TODO: Add the graph...
\end{questions}
\end{document}